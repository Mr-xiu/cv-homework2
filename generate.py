...
class Generate:
    ...
    def load_img_and_sift(self, data_path):
        ...
        for sub_folder in sub_folder_list:
            ...
            for file in file_list:
                ...
                self.dataset.append(des)
                self.label.append(sub_folder)
    ...
    def kmeans(self, clusters_num):
        ...
        :return 产生的聚类模型
        """
        kmeans_data = np.vstack(self.dataset)  # 将不同图像的特征合起来
    ...
    def generate_bag_of_words(self, kmeans):
        ...
        for data in self.dataset:
            ...
            self.bag_of_words.append(hist)

    def save_result(self):

        np.save('data/generate/bag_of_words.npy',np.array(self.bag_of_words))
        np.save('data/generate/label.npy', np.array(self.label))
